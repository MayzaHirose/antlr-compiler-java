			...
			if(simbolo.getTipoDeDado() == null) {
				...
				case "bool":
					if(simbolo.getValor() != null) {
						if(GraceSemanticRules.verificaVariavelInicializadaComTipoCorreto(simbolo.getValor(), TipoDeDado.BOOL)) {
							simbolo.setTipoDeDado(TipoDeDado.BOOL); 
						} else {
							System.err.println("Erro Semântico -> Linha: " + ctx.start.getLine() + "  Coluna:" + ctx.start.getCharPositionInLine() + "\t Tipo incompativel. Esperado tipo bool. Encontrado: " + simbolo.getCadeia() + "=" + simbolo.getValor());
						}
					}
					break;
				case "int":
					if(simbolo.getValor() != null) {
						if(GraceSemanticRules.verificaVariavelInicializadaComTipoCorreto(simbolo.getValor(), TipoDeDado.INT)) {
							simbolo.setTipoDeDado(TipoDeDado.INT);
						} else {
							System.err.println("Erro Semântico -> Linha: " + ctx.start.getLine() + "  Coluna:" + ctx.start.getCharPositionInLine() + "\t Tipo incompativel. Esperado tipo int. Encontrado: " + simbolo.getCadeia() + "=" + simbolo.getValor());
						}
					}
					break;
				case "string":
					if(simbolo.getValor() != null) {
						if(GraceSemanticRules.verificaVariavelInicializadaComTipoCorreto(simbolo.getValor(), TipoDeDado.STRING)) {
							simbolo.setTipoDeDado(TipoDeDado.STRING);
						} else {
							System.err.println("Erro Semântico -> Linha: " + ctx.start.getLine() + "  Coluna:" + ctx.start.getCharPositionInLine() + "\t Tipo incompativel. Esperado tipo string. Encontrado: " + simbolo.getCadeia() + "=" + simbolo.getValor());
						}
					}
					break;
				}
