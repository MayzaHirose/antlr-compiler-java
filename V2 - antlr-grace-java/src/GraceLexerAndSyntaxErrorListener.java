...
public class GraceLexerAndSyntaxErrorListener implements ANTLRErrorListener {
	public static GraceLexerAndSyntaxErrorListener INSTANCE = new GraceLexerAndSyntaxErrorListener();
	...
	public void syntaxError(Recognizer<?, ?> rcgnzr, Object offendingSymbol, int line, int charPositionInLine, String msg, RecognitionException re) {
		...
		if(offendingSymbol instanceof Token){
		   ...
		   // Erro léxico
		   if(token.getType() == GraceGrammarLexer.ERROR_CHAR){
